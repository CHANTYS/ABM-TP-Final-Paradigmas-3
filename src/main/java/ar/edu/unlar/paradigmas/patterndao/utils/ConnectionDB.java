 ...
 */
package ar.edu.unlar.paradigmas.patterndao.utils;
...
public class ConnectionDB {
   ...
   static final String DB_URL = "jdbc:postgresql://localhost:5432/gestion_comercio";
